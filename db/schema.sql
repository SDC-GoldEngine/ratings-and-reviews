...
CREATE INDEX char_review_char_id_index ON characteristic_reviews (characteristic_id);
CREATE INDEX char_review_review_id_index ON characteristic_reviews (review_id);
